...
* [Why do we need this AsyncESP32_SC_Ethernet_Manager library](#why-do-we-need-this-async-AsyncESP32_SC_Ethernet_Manager-library)
  * [Features](#features)
...
* [Debug Terminal Output Samples](#debug-terminal-output-samples)
  ...
  * [4. Async_ConfigOnDoubleReset_TZ using LittleFS on ESP32S2_DEV with ESP32_S2_ENC28J60](#4-Async_ConfigOnDoubleReset_TZ-using-LittleFS-on-ESP32S2_DEV-with-ESP32_S2_ENC28J60)
* [Debug](#debug)
...
### Why do we need this Async [AsyncESP32_SC_Ethernet_Manager library](https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager)

#### Features

This is an `ESP32_S2/S3/C3 + LwIP LwIP W5500 / ENC28J60` Credentials and Connection Manager with fallback Web ConfigPortal. This Library is used for configuring ESP32_S2/S3/C3 Ethernet Static / DHCP and Credentials at runtime. You can specify static DNS servers, personalized HostName and CORS feature.

This library is based on, modified, bug-fixed and improved from:

1. [`Khoi Hoang's ESPAsync_WiFiManager`](https://github.com/khoih-prog/ESPAsync_WiFiManager)

to use the better and faster **asynchronous** [ESPAsyncWebServer](https://github.com/me-no-dev/ESPAsyncWebServer).

Thanks to this [AsyncESP32_SC_Ethernet_Manager library](https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager) is based on and sync'ed with [`ESPAsync_WiFiManager`](https://github.com/khoih-prog/ESPAsync_WiFiManager), all the features currently supported by [`ESPAsync_WiFiManager`](https://github.com/khoih-prog/ESPAsync_WiFiManager) will be available. Please have a look at [`ESPAsync_WiFiManager`](https://github.com/khoih-prog/ESPAsync_WiFiManager) for those too-many-to-list features.
...
This [**AsyncESP32_SC_Ethernet_Manager** library](https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager) currently supports these following boards:
...
<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager/raw/main/Images/ESP32S3_DEV.png">
</p> 
...
<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager/raw/main/Images/W5500.png">
</p>

<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager/raw/main/Images/W5500_small.png">
</p> 

##### ENC28J60

<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager/raw/main/Images/ENC28J60.png">
</p>
...
## Prerequisites
 ...
 7. [`WebServer_ESP32_SC_W5500 library v1.2.1+`](https://github.com/khoih-prog/WebServer_ESP32_SC_W5500) if necessary to use `ESP32_S2/S3/C3` boards with `LwIP W5500` Ethernet. To install, check [![arduino-library-badge](https://www.ardu-badge.com/badge/WebServer_ESP32_SC_W5500.svg?)](https://www.ardu-badge.com/WebServer_ESP32_SC_W5500)
 8. [`WebServer_ESP32_SC_ENC library v1.2.0+`](https://github.com/khoih-prog/WebServer_ESP32_SC_ENC) if necessary to use `ESP32_S2/S3/C3` boards with `LwIP ENC28J60` Ethernet. To install, check [![arduino-library-badge](https://www.ardu-badge.com/badge/WebServer_ESP32_SC_ENC.svg?)](https://www.ardu-badge.com/WebServer_ESP32_SC_ENC)
...
The best and easiest way is to use `Arduino Library Manager`. Search for `AsyncESP32_SC_Ethernet_Manager`, then select / install the latest version. You can also use this link [![arduino-library-badge](https://www.ardu-badge.com/badge/AsyncESP32_SC_Ethernet_Manager.svg?)](https://www.ardu-badge.com/AsyncESP32_SC_Ethernet_Manager) for more detailed instructions.

### Manual Install

1. Navigate to [AsyncESP32_SC_Ethernet_Manager](https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager) page.
2. Download the latest release `AsyncESP32_SC_Ethernet_Manager-main.zip`.
3. Extract the zip file to `AsyncESP32_SC_Ethernet_Manager-main` directory 
4. Copy the whole `AsyncESP32_SC_Ethernet_Manager-main` folder to Arduino libraries' directory such as `~/Arduino/libraries/`.

### VS Code & PlatformIO:

1. Install [VS Code](https://code.visualstudio.com/)
2. Install [PlatformIO](https://platformio.org/platformio-ide)
3. Install [**AsyncESP32_SC_Ethernet_Manager** library](https://registry.platformio.org/libraries/khoih-prog/AsyncESP32_SC_Ethernet_Manager) by using [Library Manager](https://registry.platformio.org/libraries/khoih-prog/AsyncESP32_SC_Ethernet_Manager/installation). Search for **AsyncESP32_SC_Ethernet_Manager** in [Platform.io Author's Libraries](https://platformio.org/lib/search?query=author:%22Khoi%20Hoang%22)
...
Thanks to [Roshan](https://github.com/solroshan) to report the issue in [Error esp_littlefs.c 'utime_p'](https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager/issues/28) 
...
```cpp
#include <AsyncESP32_SC_Ethernet_Manager.hpp>               //https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager
```

in many files. But be sure to use the following `#include <AsyncESP32_SC_Ethernet_Manager.h>` **in just 1 `.h`, `.cpp` or `.ino` file**, which must **not be included in any other file**, to avoid `Multiple Definitions` Linker Error
...
Have a look at the discussion in [Different behaviour using the src_cpp or src_h lib #80](https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager/discussions/80)
...
```cpp
//AsyncESP32_SC_Ethernet_manager.setSTAStaticIPConfig(stationIP, gatewayIP, netMask, dns1IP, dns2IP);
AsyncESP32_SC_Ethernet_manager.setSTAStaticIPConfig(WM_STA_IPconfig);
```
...
```cpp
const char * TZ_Result = AsyncESP32_SC_Ethernet_manager.getTZ(_timezoneName);
```
...
```cpp
AsyncESP32_SC_Ethernet_Manager AsyncESP32_SC_Ethernet_manager(&webServer, &dnsServer, "Personalized-HostName");
```

then later call

```cpp
AsyncESP32_SC_Ethernet_manager.startConfigPortal()
```
...
These illustrating steps is based on the example [Async_ConfigOnSwitchFS](https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager/tree/main/examples/Async_ConfigOnSwitchFS)
...
The example [Async_ConfigOnSwitchFS](https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager/tree/main/examples/Async_ConfigOnSwitchFS) will open the CP whenever a SW press is detected in `loop()`. So the code to add `dynamic variables` will be there, just after the CP `AsyncESP32_SC_Ethernet_Manager` class initialization to create `AsyncESP32_SC_Ethernet_Manager` object.
...
// is configuration portal requested?
  if ((digitalRead(TRIGGER_PIN) == LOW) || (digitalRead(TRIGGER_PIN2) == LOW))
  {
    ...
    AsyncESP32_SC_Ethernet_Manager AsyncESP32_SC_Ethernet_manager(&webServer, &dnsServer, "ConfigOnSwitchFS");
...
Adding those `ESPAsync_EMParameter` objects created in Step 2 using the function `addParameter()` of object `AsyncESP32_SC_Ethernet_Manager`
...
AsyncESP32_SC_Ethernet_manager.addParameter(&p_thingspeakApiKey);
AsyncESP32_SC_Ethernet_manager.addParameter(&p_sensorDht22);
AsyncESP32_SC_Ethernet_manager.addParameter(&p_pinSda);
AsyncESP32_SC_Ethernet_manager.addParameter(&p_pinScl);
```
...
After users select `Save`, the CP `AsyncESP32_SC_Ethernet_Manager` object will save the user input data into related `ESPAsync_EMParameter` objects.
...
<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager/raw/main/Images/Main.png">
</p>

Select `Information` to enter the Info page where the board info will be shown (long page)

<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager/raw/main/Images/Info.png">
</p>
...
<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager/raw/main/Images/Configuration_Standard.png">
</p>
...
<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager/raw/main/Images/Saved.png">
</p>
...
```cpp
AsyncESP32_SC_Ethernet_manager.setSaveConfigCallback(saveConfigCallback);
```
...
void loop()
{
  ...
  if ((digitalRead(TRIGGER_PIN) == LOW) || (digitalRead(TRIGGER_PIN2) == LOW))
  {
    ...
    AsyncESP32_SC_Ethernet_Manager AsyncESP32_SC_Ethernet_manager(&webServer, NULL, "ConfigOnSwitch");
#else
    AsyncDNSServer dnsServer;

    AsyncESP32_SC_Ethernet_Manager AsyncESP32_SC_Ethernet_manager(&webServer, &dnsServer, "ConfigOnSwitch");
#endif
    ...
    AsyncESP32_SC_Ethernet_manager.setSTAStaticIPConfig(stationIP, gatewayIP, netMask);
#endif
#endif
...
Many applications need configuration parameters like `MQTT host and port`, [Blynk](http://www.blynk.cc) or [emoncms](http://emoncms.org) tokens, etc. While it is possible to use [`AsyncESP32_SC_Ethernet_Manager`](https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager) to collect additional parameters, it is better to read these parameters from a web service once [`AsyncESP32_SC_Ethernet_Manager`](https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager) has been used to connect to the Internet.

To capture other parameters with [`AsyncESP32_SC_Ethernet_Manager`](https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager) is a little bit more complicated than all the other features. This requires adding custom HTML to your form. 

If you want to do it with [`AsyncESP32_SC_Ethernet_Manager`](https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager) see the example [Async_ConfigOnSwitchFS](examples/Async_ConfigOnSwitchFS)
...
```cpp
AsyncESP32_SC_Ethernet_manager.setSTAStaticIPConfig(IPAddress(192,168,2,232), IPAddress(192,168,2,1), IPAddress(255,255,255,0));
```
...
```cpp
AsyncESP32_SC_Ethernet_manager.setCustomHeadElement("<style>html{filter: invert(100%); -webkit-filter: invert(100%);}</style>");
```
...
AsyncESP32_SC_Ethernet_manager.addParameter(&custom_text);
```
...
<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager/raw/main/Images/ESP32S2_DEV.png">
</p> 
...
<p align="center">
    <img src="https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager/raw/main/Images/ESP32_C3_DevKitC_02.png">
</p> 
...
https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager/blob/2ac6022bc78d40d5eaf4bbb45c70c2317882b2b4/examples/Async_ConfigOnSwitch/Async_ConfigOnSwitch.ino#L26-L1011
...
This is terminal debug output when running [Async_ConfigOnDoubleReset](examples/Async_ConfigOnDoubleReset) on  **ESP32_S3_ENC28J60**.


```
Starting Async_ConfigOnDoubleReset_TZ using LittleFS on ESP32S3_DEV with ESP32_S3_ENC28J60
AsyncESP32_SC_Ethernet_Manager v1.1.0
...
Local Date/Time: Fri Dec 23 20:31:54 2022
Stop doubleResetDetecting
Saving config file...
Saving config file OK
After waiting 0.00 secs more in setup(), connection result is connected. Local IP: 192.168.2.105
[EM] freeing allocated params!
Local Date/Time: Fri Dec 23 20:32:54 2022
Stop doubleResetDetecting
Saving config file...
Saving config file OK
Local Date/Time: Fri Dec 23 20:33:52 2022
Local Date/Time: Fri Dec 23 20:34:52 2022
Local Date/Time: Fri Dec 23 20:35:52 2022
```
...
Config file was successfully saved
[EM] freeing allocated params!
Local Date/Time: Fri Dec 23 20:36:52 2022
Local Date/Time: Fri Dec 23 20:37:52 2022
```
...
#### 4. Async_ConfigOnDoubleReset_TZ using LittleFS on ESP32S2_DEV with ESP32_S2_ENC28J60
...
Saving config file...
Saving config file OK
After waiting 0.00 secs more in setup(), connection result is connected. Local IP: 192.168.2.132
[EM] freeing allocated params!
Stop doubleResetDetecting
Saving config file...
Saving config file OK
Local Date/Time: Fri Dec 23 20:26:52 2022
Local Date/Time: Fri Dec 23 20:27:52 2022
Local Date/Time: Fri Dec 23 20:28:52 2022
Local Date/Time: Fri Dec 23 20:29:52 2022
Local Date/Time: Fri Dec 23 20:30:52 2022
Local Date/Time: Fri Dec 23 20:31:52 2022
Local Date/Time: Fri Dec 23 20:32:52 2022
```
...
```cpp
AsyncESP32_SC_Ethernet_manager.setDebugOutput(false);
```
...
Submit issues to: [AsyncESP32_SC_Ethernet_Manager issues](https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager/issues)
...
- The library is licensed under [MIT](https://github.com/khoih-prog/AsyncESP32_SC_Ethernet_Manager/blob/main/LICENSE)
