...
#if ( USING_ESP32_S2 || USING_ESP32_C3 )
  AsyncESP32_SC_Ethernet_Manager AsyncESP32_SC_Ethernet_manager(&webServer, NULL, "AsyncConfigOnSwitch");
#else
  AsyncDNSServer dnsServer;

  AsyncESP32_SC_Ethernet_Manager AsyncESP32_SC_Ethernet_manager(&webServer, &dnsServer, "AsyncConfigOnSwitch");
#endif
