...
void setup()
{
  ...
  AsyncESP32_SC_Ethernet_Manager AsyncESP32_SC_Ethernet_manager(&webServer, NULL, "AsyncCP-ParamsOnSW");
#else
  AsyncDNSServer dnsServer;

  AsyncESP32_SC_Ethernet_Manager AsyncESP32_SC_Ethernet_manager(&webServer, &dnsServer, "AsyncCP-ParamsOnSW");
#endif
