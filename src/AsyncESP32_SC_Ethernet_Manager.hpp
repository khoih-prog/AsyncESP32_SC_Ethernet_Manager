/****************************************************************************************************************************
  AsyncESP32_SC_Ethernet_Manager.hpp
...
#ifndef AsyncESP32_SC_Ethernet_Manager_hpp
#define AsyncESP32_SC_Ethernet_Manager_hpp
...
#include "AsyncESP32_SC_Ethernet_Manager_Debug.h"
...
class ESPAsync_EMParameter 
{
  ...
  private:
    ...
    friend class AsyncESP32_SC_Ethernet_Manager;
};
...
class AsyncESP32_SC_Ethernet_Manager
{
  public:

    AsyncESP32_SC_Ethernet_Manager(AsyncWebServer * webserver, AsyncDNSServer *dnsserver, const char *iHostname = "");
...
#endif    // AsyncESP32_SC_Ethernet_Manager_hpp
